...
namespace UnityEngine.InputSystem.Switch.LowLevel
{
    ...
    internal struct NPadInputState : IInputStateTypeInfo
    {
        ...
        [InputControl(name = "acceleration", displayName = "primaryAcceleration", aliases = new[] {"primaryAcceleration", "leftJoyconAcceleration"}, noisy = true)]
        [FieldOffset(20)]
        public Vector3 acceleration;

        [InputControl(name = "attitude", displayName = "primaryAttitude",  aliases = new[] {"primaryAttitude", "leftJoyconAttitude"}, noisy = true)]
        [FieldOffset(32)]
        public Quaternion attitude;

        [InputControl(name = "angularVelocity", displayName = "primaryAngularVelocity", aliases = new[] {"primaryAngularVelocity", "leftJoyconAngularVelocity"}, noisy = true)]
        [FieldOffset(48)]
        public Vector3 angularVelocity;
        
#if UNITY_INPUTSYSTEM_SWITCH_2SIXAXIS
        [InputControl(name = "secondaryAcceleration", alias = "rightJoyconAcceleration", noisy = true)]
        [FieldOffset(60)]
        public Vector3 secondaryAcceleration;

        [InputControl(name = "secondaryAttitude", alias = "rightJoyconAttitude", noisy = true)]
        [FieldOffset(72)]
        public Quaternion secondaryAttitude;

        [InputControl(name = "secondaryAngularVelocity", alias = "rightJoyconAngularVelocity", noisy = true)]
        [FieldOffset(88)]
        public Vector3 secondaryAngularVelocity;
#endif
...
namespace UnityEngine.InputSystem.Switch
{
    ...
    public class NPad : Gamepad, INPadRumble
    {
        ...
        [Obsolete("acceleration is obsolete. Use primaryAcceleration instead (UnityUpgradable) -> primaryAcceleration", false)]
        public Vector3Control acceleration => primaryAcceleration;

        [Obsolete("attitude is obsolete. Use primaryAttitude instead (UnityUpgradable) -> primaryAttitude", false)]
        public QuaternionControl attitude => primaryAttitude;

        [Obsolete("angularVelocity is obsolete. Use primaryAngularVelocity instead (UnityUpgradable) -> primaryAngularVelocity", false)]
        public Vector3Control angularVelocity => primaryAngularVelocity;
        
        /// <summary>
        /// Acceleration for the Primary Controller, for controllers in styles other than <see cref="NpadStyles.JoyDual"/>
        /// this will be the only acceleration value
        /// </summary>
        public Vector3Control primaryAcceleration { get; private set; }
        
        /// <summary>
        /// Attitude for the Primary Controller, for controllers in styles other than <see cref="NpadStyles.JoyDual"/>
        /// this will be the only attitude value
        /// </summary>
        public QuaternionControl primaryAttitude { get; private set; }
        
        /// <summary>
        /// Angular Velocity for the Primary Controller, for controllers in styles other than <see cref="NpadStyles.JoyDual"/>
        /// this will be the only angular velocity value
        /// </summary>
        public Vector3Control primaryAngularVelocity { get; private set; }
        
#if UNITY_INPUTSYSTEM_SWITCH_2SIXAXIS
        /// <summary>
        /// Acceleration for the Secondary Controller, this will be the acceleration of Right Joycon in
        /// the <see cref="NpadStyles.JoyDual"/> style. In all other styles it will provide a zero value
        /// </summary>
        public Vector3Control secondaryAcceleration { get; private set; }
        
        /// <summary>
        /// Attitude for the Secondary Controller, this will be the attitude of Right Joycon in
        /// the <see cref="NpadStyles.JoyDual"/> style. In all other styles it will provide a zero value
        /// </summary>
        public QuaternionControl secondaryAttitude { get; private set; }
        
        /// <summary>
        /// Angular Velocity for the Secondary Controller, this will be the angular velocity of Right Joycon in
        /// the <see cref="NpadStyles.JoyDual"/> style. In all other styles it will provide a zero value
        /// </summary>
        public Vector3Control secondaryAngularVelocity { get; private set; }
#endif
        
        
        //Aliases for Six-Axis values
        public Vector3Control leftControllerAcceleration => primaryAcceleration;
        public QuaternionControl leftControllerAttitude => primaryAttitude;
        public Vector3Control leftControllerAngularVelocity => primaryAngularVelocity;
#if UNITY_INPUTSYSTEM_SWITCH_2SIXAXIS
        public Vector3Control rightControllerAcceleration => secondaryAcceleration;
        public QuaternionControl rightControllerAttitude => secondaryAttitude;
        public Vector3Control rightControllerAngularVelocity => secondaryAngularVelocity;
#endif
        ...
        protected override void FinishSetup()
        {
            ...
            primaryAcceleration = GetChildControl<Vector3Control>("acceleration");
            primaryAttitude = GetChildControl<QuaternionControl>("attitude");
            primaryAngularVelocity = GetChildControl<Vector3Control>("angularVelocity");
#if UNITY_INPUTSYSTEM_SWITCH_2SIXAXIS            
            secondaryAcceleration = GetChildControl<Vector3Control>("secondaryAcceleration");
            secondaryAttitude = GetChildControl<QuaternionControl>("secondaryAttitude");
            secondaryAngularVelocity = GetChildControl<Vector3Control>("secondaryAngularVelocity");
#endif
        }
