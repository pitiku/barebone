...
[System.Serializable]
public class PlaySoundXY : SoundEvent
{
    ...
    public override void play()
    {
        ...
        m_oSource = AudioManager.Instance.playAudioClipXY(m_oAudio, transform.posXY(), m_fVolume, m_bLoops, 1.0f, GameStateManager.APPLICATION_TIMER, m_oMixerGroup);
    }
