...
namespace I2.Loc
{
    public static class I2Utils
    {
        ...
        {
            return FindObject(SceneManager.GetSceneAt(SceneManager.sceneCount - 1), objectPath);
        }


        public static Transform FindObject(Scene scene, string objectPath)
        {
            //var roots = SceneManager.GetSceneAt(SceneManager.sceneCount - 1).GetRootGameObjects();
