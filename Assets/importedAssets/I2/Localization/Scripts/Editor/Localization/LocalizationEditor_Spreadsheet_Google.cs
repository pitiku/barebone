...
namespace I2.Loc
{
	...
	{
        #region Variables
        public delegate void OnLocalizationImportedCallback();
        public static event OnLocalizationImportedCallback OnLocalizationImportedEvent;
		...
		void OnImported_Google( string Result, string Error, eSpreadsheetUpdateMode UpdateMode )
		{
			...
			if (OnLocalizationImportedEvent != null) OnLocalizationImportedEvent();
        }
