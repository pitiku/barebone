...
namespace Rewired.Platforms.UnityInputSystem.PS5 {
    ...
    public partial class UnityInputSystemPS5InputSource : Rewired.Platforms.UnityInputSystem.UnityInputSystemInputSource {
        ...
        protected class PS5Joystick : Joystick, IPS5InputDevice {

            private const float VIBRATION_RENEW_INTERVAL = 2.0f; // renew vibration every x seconds

            int IPS5InputDevice.slotIndex { get { return source.slotIndex; } }

            protected UnityEngine.InputSystem.PS5.DualSenseGamepad source {
                get {
                    return inputDevice as UnityEngine.InputSystem.PS5.DualSenseGamepad;
                }
            }

            public PS5Joystick(InitOptions initOptions) : base(initOptions) {
            ...
            protected override void OnCreateExtensions(System.Collections.Generic.IList<Rewired.Controller.Extension> extensions) {
                if (!Contains<Rewired.Controller.Extension, Rewired.Platforms.PS5.PS5ControllerExtension>(extensions)) {
                    extensions.Add(
                        new Rewired.Platforms.PS5.PS5ControllerExtension(
            ...
            new public class InitOptions : Joystick.InitOptions {
                ...
                public InitOptions(UnityEngine.InputSystem.PS5.DualSenseGamepad dualSenseGamepad, string displayName, string matchingTag)
                    : base(UnityInputSystemDeviceType.OtherJoystick, dualSenseGamepad) {
