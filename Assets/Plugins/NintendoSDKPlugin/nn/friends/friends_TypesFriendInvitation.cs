...
namespace nn.friends
{
    ...
    public struct FriendInvitationGameModeDescription
    {
        ...
        private void Set(string value, Language language)
        {
            ...
            data[(int)language * TextSize + length] = 0;
        }
    }

    [StructLayout(LayoutKind.Sequential)]
    public struct FriendInvitationGameModeDescriptionV2
    {
        public const int TextSize = 192;
        ...
        public string pl
        {
            get { return Get(Language.pl); }
            set { Set(value, Language.pl); }
        }
        public string th
        {
            get { return Get(Language.th); }
            set { Set(value, Language.th); }
        }
        private enum Language
        {
            EnUs = 0,
